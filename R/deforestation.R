...
#' @param area numeric, the area (in hectares) of deforestation related to an specific land cover, if it is not calculated by the number of points
...
defor_emiss<-function( emission_factor, error_ef=0, points, total_area, years, total_points, new_land_cover="the new land cover", area="auto", error=0){
